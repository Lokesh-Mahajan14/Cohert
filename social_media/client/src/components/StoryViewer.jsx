...
function StoryViewer({viewStory,setViewStory}) {
  ...
  return (
    <div className='fixed inset-0 z-[110] h-screen bg-black/80 bg-opacity-90  flex items-center justify-center 'style={{backgroundColor:viewStory.media_type==='text'?viewStory.background_color:'#000000'}}>
        ...
        <div onClick={()=>handleClose()}>
            <X className='absolute top-0 right-0 mx-2 mt-4 text-white size-8 transition cursor-pointer' />
        </div>

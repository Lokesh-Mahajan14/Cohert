...
function Sidebar({sidebarOpen,setsidebarOpen}) {
  ...
  return (
    <div className={`flex flex-col w-60 xl:w-72 bg-white border-r border-grey-200 items-center justify-between max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen? 'translate-x-0':'max-sm:translate-x-full'} transition-all duration-300 ease-in-out`}>
        ...
        <div className='w-full border-t border-gray-300 p-4 px-7 flex flex-center justify-between'>

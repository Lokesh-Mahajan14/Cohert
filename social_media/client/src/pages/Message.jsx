  ...
  return (
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        <div className='mb-8'>
          <h1 className='text-bold text-2xl text-slate-900 mb-2'>Messages</h1>
          <p className='text-slate-500'>Talk to your friends and family</p>
        </div>
        <div className='flex flex-col gap-3'>
          {dummyConnectionsData.map((user)=>(
            <div key={user._id} className='max-w-xl f lex flex-wrap gap-6 p-6 bg-white shadow rounded-md'>
                <img src={user.profile_picture} className='size-12 mx-auto rounded-full'/>
